    ...
    <div className="min-h-screen bg-ofa-bg-dark flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Medewerker App</p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-neutral-700 bg-ofa-bg-dark text-ofa-red focus:ring-ofa-red focus:ring-offset-0"
                />
